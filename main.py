...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='./datasets/MSL')
    parser.add_argument('--model_save_path', type=str, default='checkpoints')
    parser.add_argument('--anomaly_ratio', type=float, default=1.0)
    parser.add_argument('--T', type=int, default=500)
    parser.add_argument('--beta_0', type=float, default=0.0001)
    parser.add_argument('--beta_T', type=float, default=0.05)
    parser.add_argument('--mask_scale', type=int, default=0)
    parser.add_argument('--masking', type=str, default='rm')
    parser.add_argument('--masking_k', type=int, default=90)
    parser.add_argument('--only_generate_missing', type=int, default=0)
